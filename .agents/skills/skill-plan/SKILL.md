...
* **Minigame System Count Standard (ครบ 13 เกมเท่านั้น):** ระบบมินิเกมของ Bear Cafe Discord Bot มีทั้งหมด **13 เกม (Game 1 - 13)** ห้ามระบุเป็น 12 หรือ 14 ใน UI, เมนูนำทาง (Navigation), คำอธิบาย หรือตัวเลือก Select เป็นอันขาด (เกม 13 คือ เรียงประโยคภาษาอังกฤษ Sentence Builder)
* **Category Display & Filtering Rule (แสดงเฉพาะเกมที่ใช้จริง):**
  - มีเฉพาะ **เกม 1, 2 (รวมถึงพูลแชร์ 6, 7)** เท่านั้นที่รองรับและแสดงผล `หมวดหมู่ (Category)` ใน Discord Bot
  - เกมอื่นๆ (เกม 3 คณิต, เกม 4 คำใบ้, เกม 5/11 เสียง TTS, เกม 8/9 คู่แปล, เกม 10 ต่อคำ, เกม 12 จริงเท็จ, เกม 13 เรียงประโยค) **ไม่ใช้งาน Category**
  - ใน UI แบบฟอร์มเพิ่ม/แก้ไข (Add/Edit Question Form) รวมถึงตัวกรองหมวดหมู่ จะต้องแสดงเฉพาะเกมที่ใช้งานจริง (`isCategoryGame([1, 2, 6, 7])`) และซ่อนออกจากเกมอื่นๆ เสมอ เพื่อลดความสับสนและป้องกันข้อมูลขยะในฐานข้อมูล
