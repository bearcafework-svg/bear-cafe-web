      ...
      <div className="relative shrink-0 px-3 pb-4 pt-1 flex flex-col items-center gap-2">
        ...
        <div className="flex items-center gap-3">
          <a href="https://discord.gg/bearcafe" target="_blank" rel="noopener noreferrer"
            className="w-9 h-9 rounded-full bg-[hsl(235,86%,65%)] text-white flex items-center justify-center hover:scale-110 transition-transform shadow-md"
            aria-label="Discord">
            <DiscordIcon />
          </a>
          <a href="https://www.tiktok.com/@bearcafe.official" target="_blank" rel="noopener noreferrer"
            className="w-9 h-9 rounded-full bg-foreground text-background flex items-center justify-center hover:scale-110 transition-transform shadow-md"
            aria-label="TikTok">
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
          ...
          <a href="https://www.youtube.com/@Bearcafe" target="_blank" rel="noopener noreferrer"
            className="w-9 h-9 rounded-full bg-destructive text-destructive-foreground flex items-center justify-center hover:scale-110 transition-transform shadow-md"
            aria-label="YouTube">
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
