...
export const MINIGAME_CONFIGS: Record<number, { id: number; name: string; icon: string; tag: string; type: string; desc: string }> = {
  1: { id: 1, name: 'เติมคำศัพท์ (ไทย)', icon: '🇹🇭', tag: 'คำศัพท์ไทย', type: 'single_thai', desc: 'เติมพยัญชนะ/สระในช่องว่าง (แชร์คลังคำศัพท์ไทยกับเกม 6)' },
  2: { id: 2, name: 'เติมคำศัพท์ (อังกฤษ)', icon: '🇬🇧', tag: 'คำศัพท์อังกฤษ', type: 'single_eng', desc: 'เติมตัวอักษรภาษาอังกฤษในช่องว่าง (แชร์คลังคำศัพท์อังกฤษกับเกม 7)' },
  ...
  6: { id: 6, name: 'พิมพ์คำต่อไปนี้ (ไทย)', icon: '⌨️', tag: 'พิมพ์เร็วไทย', type: 'typing_th', desc: 'พิมพ์ข้อความหรือประโยคภาษาไทยให้ถูกต้องรวดเร็ว (แชร์คลังคำศัพท์ไทยกับเกม 1)' },
  7: { id: 7, name: 'พิมพ์คำต่อไปนี้ (อังกฤษ)', icon: '💻', tag: 'พิมพ์เร็วอังกฤษ', type: 'typing_en', desc: 'พิมพ์ข้อความหรือประโยคภาษาอังกฤษให้ถูกต้องรวดเร็ว (แชร์คลังคำศัพท์อังกฤษกับเกม 2)' },
  8: { id: 8, name: 'ทายคำแปลภาษาอังกฤษ', icon: '🌐', tag: 'คู่คำแปล (EN ➔ TH)', type: 'translation', desc: 'โจทย์ภาษาอังกฤษ ➔ ตัวเลือกคำแปลไทย (แชร์คู่คำแปลกับเกม 9)' },
  9: { id: 9, name: 'ทายคำแปลภาษาไทย', icon: '🇹🇭', tag: 'คู่คำแปล (TH ➔ EN)', type: 'translation', desc: 'โจทย์ภาษาไทย ➔ ตัวเลือกคำแปลอังกฤษ (แชร์คู่คำแปลกับเกม 8)' },
