      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            ...
            position === "popper" &&
              "w-full min-w-[var(--radix-select-trigger-width)] min-h-0 max-h-[var(--radix-select-content-available-height,22rem)] overflow-y-auto",
          )}
        >
          {children}
        </SelectPrimitive.Viewport>
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-lg py-1.5 pl-8 pr-2 text-sm outline-none touch-pan-y data-[disabled]:pointer-events-none data-[disabled]:opacity-50 focus:bg-accent focus:text-accent-foreground",
      className,
    )}
    {...props}
  >
