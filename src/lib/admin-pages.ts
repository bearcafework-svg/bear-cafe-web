...
export const ADMIN_PAGES: AdminPageDef[] = [
  ...
  { id: 'campaigns', label: 'จัดการโฆษณา', group: 'content', groupLabel: 'เนื้อหา', ownerOnly: true },
  ...
  { id: 'minigames', label: 'จัดการมินิเกม', group: 'content', groupLabel: 'เนื้อหา', ownerOnly: true },
];
