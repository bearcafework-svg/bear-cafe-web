  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      ...
      >
        ...
        <button onClick={() => onRate(0)} className="text-xs text-[#9c7c5e] hover:text-[#7c5c3e]">ข้ามไปก่อน</button>
      </motion.div>
    </div>
  );
}
...
export default function SecretChatRoom() {
  ...
  // ── Countdown (only active when matched) ──
  ...
  // ── Realtime: messages + session updates + typing ──
  useEffect(() => {
    ...
    <div className="fixed inset-0 flex flex-col bg-[#faf6f1] dark:bg-[#1a1410]">
      ...
      <header className="shrink-0 bg-[#faf6f1]/95 dark:bg-[#1a1410]/95 backdrop-blur-md border-b border-[#e8d9c8] dark:border-[#3a2a1e] px-4 py-3 flex items-center justify-between z-20">
        ...
        <div className="flex items-center gap-1.5">
          ...
          {/* Leave */}
          <button onClick={leaveTable} className="w-8 h-8 rounded-full flex items-center justify-center text-[#9c7c5e] hover:text-red-500 border border-[#e8d9c8] hover:border-red-300 transition-all" title="ออกจากโต๊ะ">
